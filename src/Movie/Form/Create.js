...
import { add as addMovie } from '../../Movies/reducer';
...
class CreateMovieForm extends React.Component {
  ...
  handleSubmitForm(event) {
    ...
    const { name, publicationDateFormatted, state } = this.state;
    const movie = { name, publicationDateFormatted, state };
...
export default connect(
  null,
  mapDispatchToProps
)(withRouter(withStyles(useStyles)(CreateMovieForm)));
